...
- (NSString *)getIndexHTMLTempletPath{
    ...
    NSString *webPath = [[NSBundle mainBundle] pathForResource:@"WebHtml" ofType:@"bundle"];
    NSString *path = [[NSBundle bundleWithPath:webPath] pathForResource:@"index" ofType:@"html"];
    return path;
}
...
- (NSString *)getcontentHTMLTempletPath{
    ...
    NSString *webPath = [[NSBundle mainBundle] pathForResource:@"WebHtml" ofType:@"bundle"];
    NSString *path = [[NSBundle bundleWithPath:webPath] pathForResource:@"content" ofType:@"html"];
    return path;
}
@end
